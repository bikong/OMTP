       %%*************************************************************************%%
       %%       PARTICLE SWARM OPRIMIZATION  FOR SUPPORT VECTOR REGRESSION        %%
       %%*************************************************************************%%
                         %%======File_name:poSVRcgp.m=======%%
                         %%======Author:Bikong===============%%


function [bestCVmse,bestc,bestg, bestp, pso_option] = psoSVRcgp(train_label,train,pso_option)
...
for i=1:pso_option.sizepop
    ...
    cmd = ['-v ',num2str(pso_option.v),' -c ',num2str( pop(i,1) ), ...
           ' -g ',num2str( pop(i,2) ), ' -p ',num2str( pop(i,3) ), '-s 3'];
